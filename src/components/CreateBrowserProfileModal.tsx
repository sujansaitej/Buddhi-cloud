...
interface CreateBrowserProfileModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function CreateBrowserProfileModal({
  isOpen,
  onClose,
  onSave
}: CreateBrowserProfileModalProps) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <Card className="w-full max-w-2xl max-h-[90vh] overflow-y-auto">
        <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
          <CardTitle className="text-xl font-semibold">Create Browser Profile</CardTitle>
